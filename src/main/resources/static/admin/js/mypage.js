...
async function fetchMemberInfo() {
        ...
        const result = await fetchWithAuth("http://localhost:10279/api/v1/members/me", {
                method: 'GET'
        });
        if (!result.ok) {
        ...
        console.log("email: " + data.memberEmail);
        console.log("no: " + data.memberNo);
        console.log("role: " + data.role);
        console.log("company: " + data.companyDomain);
